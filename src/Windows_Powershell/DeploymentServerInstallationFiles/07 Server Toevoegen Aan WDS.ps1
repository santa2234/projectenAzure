...
# Image van Windows Server toevoegen aan WDS
Write-Host -ForegroundColor Yellow "Image van Windows Server toevoegen aan WDS."

$ImageFile = $DriveLetter + ":\" + $ServerPath + "\Boot\LiteTouchPE_x64.wim"
$FileName = $ServerID + ".wim"
wdsutil /Verbose /Progress /Add-Image /ImageFile:$ImageFile /ImageType:Boot /Name:$ServerID /Filename:$FileName
